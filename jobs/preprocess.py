"""
This script handles data ingestion and feature table updates for a loan prediction system.
...
if affected_rows_train > 0 or affected_rows_test > 0:
    spark.sql(f"""
        ...
        INSERT INTO {catalog_name}.{schema_name}.loan_features
        SELECT id, cb_person_cred_hist_length, loan_amnt, person_age,person_income
        FROM {catalog_name}.{schema_name}.train_set
